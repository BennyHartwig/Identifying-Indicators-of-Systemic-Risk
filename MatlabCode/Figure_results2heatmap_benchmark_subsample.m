...
%                 load(strcat('../results/results_',data_freq(6:end),'_',country,'_',dep1_name ,'_',dep2_name))
                ...
                load(strcat('results/smpl1985/results_',country,'_',mname,'_',dep1_name ,'_',dep2_name))
            ...
            for yy = 1 : length(all_TestType)
                for zz = 1 : length(all_STDname)
                    ...
                    for ii = 1 : length(vnames)
                        ...
                        fullFolderName = strcat(Folder,'\figures\smpl1985\',output_name,'\',TestType,'\',STDname,'\',data_freq,'_',dep1_name,'_',dep2_name,'\');
