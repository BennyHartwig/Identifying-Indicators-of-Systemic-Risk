...
load(data_freq)
                 ...
                 vnames_dict = {'cqgap','Basel III credit-to-GDP gap';...
                     ...
                     'd1lrtcredit','Real credit growth (sos)';...
                     'd2lrtcredit','Real credit growth (yoy)';...
                     'd4lrtcredit','Real credit growth (2yo2y)';...
                     'd6lrtcredit','Real credit growth (3yo3y)';...
                     'd1lRPPI','Real house price growth (sos)';...
                     'd2lRPPI','Real house price growth (yoy)';...
                     'd4lRPPI','Real house price growth (2yo2y)';...
                     'd6lRPPI','Real house price growth (3yo3y)';...
                     'd1lrstock','Real stock price growth (sos)';...
                     'd2lrstock','Real stock price growth (yoy)';...
                     'd4lrstock','Real stock price growth (2yo2y)';...
                     'd6lrstock','Real stock price growth (3yo3y)';...
                     'd1lcabgdp','Current account balance (% of GDP) (sos)';...
                     'd2lcabgdp','Current account balance (% of GDP) (yoy)';...
                     'd4lcabgdp','Current account balance (% of GDP) (2yo2y)';...
                     'd6lcabgdp','Current account balance (% of GDP) (3yo3y)';...
                     'd1lreer','REER (sos)';...
                     'd2lreer','REER (yoy)';...
                     'd4lreer','REER (2yo2y)';...
                     'd6lreer','REER (3yo3y)';...
                     'd1lrbondpr','Real bond price growth (qoq)';...
                     'd2lrbondpr','Real bond price growth (yoy)'};
                   
vnames = vnames_dict(:,1); vnames_label = vnames_dict(:,2);

                    
                    pOPT =0; mOPT = 2;
                    horizon_legend = num2cell([0:10]); %0:20
                    xlabel_name = {'Half-years ahead'};
...
%                 load(strcat('../results/results_',data_freq(6:end),'_',country,'_',dep1_name ,'_',dep2_name))
                ...
                load(strcat('results/smpl1970_semia/results_',country,'_',mname,'_',dep1_name ,'_',dep2_name))
            ...
            for yy = 1 : length(all_TestType)
                for zz = 1 : length(all_STDname)
                    ...
                    for ii = 1 : length(vnames)
                        ...
                        fullFolderName = strcat(Folder,'\figures\smpl1970_semia\',output_name,'\',TestType,'\',STDname,'\',data_freq,'_',dep1_name,'_',dep2_name,'\');
